...
![Project Screenshot](https://50projects50days.com/img/projects-img/37-pokedex.png)

</div>

# Pokemon Pedia / Pokedex

App which shows the pokemon character and it's details, Thanks to https://pokeapi.co/api/v2/pokemon for making this possible. This is built using Vanilla Js and Async await function to get the data from API.  
